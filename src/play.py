...
from error_process import max_column, max_row, restore_times, win_condition
...
class Numbers:
    ...
    def random_generator(self):
        ...
        if check_index:
            ...
            if split == True:
                ...
                self._data_dict[current_index][rand_index1[0]][
                    rand_index1[1]
                ] = rand_number
                self._data_dict[current_index][rand_index2[0]][
                    rand_index2[1]
                ] = rand_number
            else:
                self._data_dict[current_index][rand_index[0]][
                    rand_index[1]
                ] = rand_number
        else:
            player1.win = False
    ...
    def moving_up(self):
        ...
        matrix = [
            [row[i] for row in temp_row_list]
